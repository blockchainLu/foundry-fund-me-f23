...
deploy-sepholia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPHOLIA_URL) --private-key $(SEPHOLIA_PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -VVVV
